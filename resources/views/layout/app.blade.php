                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="main-menu">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                              <a href="#" title="Search" data-toggle="modal" data-target="#search"><span class="visible-xs">Search</span><span class="hidden-xs glyphicon glyphicon-search"></span></a>
                            </li>
                            <li>
                              <a href="/donations" title="Donations"><span class="visible-xs">Donations</span> <span class="hidden-xs glyphicon glyphicon-heart"></span></a>
                            </li>
                            @if(Auth::check())
                            <li class="dropdown">
                                <a class="dropdown-toggle " href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{ Auth::user()->nickname }} <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    @if(Auth::user()->type == "A" OR Auth::user()->type == "H")
                                    <li>
                            ...
                            @else
                            <li class="steamli" style="padding-top: 8px;"><a href="/login" class="btn btn-success"  style="color:white; height: 30px; padding-top: 5px;">Sign in with Steam</a></li>
                            @endif
                        </ul>
                    </div>
              </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>
                    <a href="#">List of planned features</a>
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
